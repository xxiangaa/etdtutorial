...
function Attribution(_ref) {
  ...
  if (((proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-starter' || (proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-enterprise') && proOptions !== null && proOptions !== void 0 && proOptions.hideAttribution) {
    return null;
  }
...
var EdgeText = function EdgeText(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("g", _objectSpread$b({
...
function getBezierPath(_ref) {
  var sourceX = _ref.sourceX,
      ...
      curvature = _ref$curvature === void 0 ? 0.25 : _ref$curvature,
      centerX = _ref.centerX,
      centerY = _ref.centerY;
  var leftAndRight = [Position.Left, Position.Right];
  var hasCurvature = curvature > 0;
  var cX,
      cY = 0;
  ...
  if (leftAndRight.includes(sourcePosition) && leftAndRight.includes(targetPosition)) {
    ...
    var distanceX = targetX - sourceX;
    var absDistanceX = Math.abs(Math.min(0, distanceX));
    var amtX = Math.sqrt(absDistanceX) / 2 * (50 * curvature);
    var hx1 = hasCurvature && distanceX < 0 ? sourceX + amtX : cX;
    var hx2 = hasCurvature && distanceX < 0 ? targetX - amtX : cX;
    return "M".concat(sourceX, ",").concat(sourceY, " C").concat(hx1, ",").concat(sourceY, " ").concat(hx2, ",").concat(targetY, ", ").concat(targetX, ",").concat(targetY);
  } else if (leftAndRight.includes(targetPosition)) {
    return "M".concat(sourceX, ",").concat(sourceY, " Q").concat(sourceX, ",").concat(targetY, " ").concat(targetX, ",").concat(targetY);
  } else if (leftAndRight.includes(sourcePosition)) {
    return "M".concat(sourceX, ",").concat(sourceY, " Q").concat(targetX, ",").concat(sourceY, " ").concat(targetX, ",").concat(targetY);
  }

  cY = typeof centerY !== 'undefined' ? centerY : _centerY;
  var distanceY = targetY - sourceY;
  var absDistanceY = Math.abs(Math.min(0, distanceY));
  var amtY = Math.sqrt(absDistanceY) / 2 * (50 * curvature);
  var hy1 = hasCurvature && distanceY < 0 ? sourceY + amtY : cY;
  var hy2 = hasCurvature && distanceY < 0 ? targetY - amtY : cY;
  return "M".concat(sourceX, ",").concat(sourceY, " C").concat(sourceX, ",").concat(hy1, " ").concat(targetX, ",").concat(hy2, " ").concat(targetX, ",").concat(targetY);
}
...
function getSimpleBezierPath(props) {
  return getBezierPath(_objectSpread$a(_objectSpread$a({}, props), {}, {
    curvature: 0
  }));
}
var SimpleBezierEdge = /*#__PURE__*/memo(function (props) {
  return /*#__PURE__*/React__default.createElement(BezierEdge, _objectSpread$a(_objectSpread$a({}, props), {}, {
    curvature: 0
  }));
});
...
export { BezierEdge, EdgeText$1 as EdgeText, Handle$1 as Handle, ReactFlowProvider, SimpleBezierEdge, SmoothStepEdge, StepEdge, StraightEdge, ReactFlow as default, getBezierPath, getCenter as getEdgeCenter, getMarkerEnd, getSimpleBezierPath, getSmoothStepPath, useEdgesState, useKeyPress, useNodesState };
